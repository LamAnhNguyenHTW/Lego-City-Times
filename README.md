...
| Zusatz-Hardening | `read_only`, `tmpfs`, `cap_drop`, gezielte `cap_add`, `no-new-privileges` |
...
| Aspekt | Status |
|---|---|
| WAF | ❌ nur Planungsnotizen (`conductor/phase-5-sonstiges.md`), kein aktiver WAF-Service |
